...
void CIt_process_list_compressed_vbyte(uint8_t *doclist, uint8_t *end, uint16_t impact, uint32_t integers, size_t offset)
{
uint32_t doc, sum;
...
/*
	...
	------------------------------------------
*/
void CIt_process_list_decompress_then_process(uint8_t *source, uint8_t *end, uint16_t impact, uint32_t integers, size_t offset)
{
uint32_t doc, sum;
uint32_t *integer, *destination = CI_decompressed_postings+offset;
...
sum = 0;
integer = CI_decompressed_postings+offset;
...
/*
	...
	---------------------------------
*/
void CIt_process_list_not_compressed(uint8_t *doclist, uint8_t *end, uint16_t impact, uint32_t integers, size_t offset)
{
uint32_t *i;
...
void CIt_process_list_compressed_qmx(uint8_t *source, uint8_t *end, uint16_t impact, uint32_t integers, size_t offset)
{
uint32_t sum, *finish, *current;
qmx_decoder.decodeArray((uint32_t *)source, end - source, CI_decompressed_postings+offset, integers);

sum = 0;
current = CI_decompressed_postings+offset;
...
void CIt_process_list_compressed_qmx_d4(uint8_t *source, uint8_t *end, uint16_t impact, uint32_t integers, size_t offset)
{
uint32_t sum, *finish, *current;

qmx_d4_decoder.decodeArray((uint32_t *)source, end - source, CI_decompressed_postings+offset, integers);
...
simple8b_decoder.decompress(CI_decompressed_postings+offset, source, integers);
